...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ul id="Details">
        ...
        <li><strong>Where:</strong> <a target="_self" href="<%=String.Format("http://m.live.com/search/LocationPage.aspx?l={0}&amp;q=map&amp;a=changelocation",Url.Encode(Model.Address + " " + Model.Country)) %>">
            <%: Model.Address %>,
            <%: Model.Country %></a></li>
